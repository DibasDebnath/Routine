...
<h1>Full Routine of Sec <?php echo $Sid;?></h1>
    ...
    echo "<table>
		...
		case 5 : echo "<tr><th>Thursday</th>"; break;
				...
				for ($Timeslot = 0; $Timeslot < 6; $Timeslot++) {
					...
					$sql = "SELECT * FROM timetable where S_id = '$Sid' and Dayslot = $Dayslot and Timeslot = $Timeslot;";
					...
					switch ($timetablerow['Grp_no']){
							case 0 : $grpno = ""; break;
							case 1 : $grpno = "G1"; break;
							case 2 : $grpno = "G2"; break;
						}
					echo "$timetablerow[T_id]  $timetablerow[C_id] $grpno  $timetablerow[R_code]</br>";
					}
					echo '</th>';
					}
			  echo "</tr>";}
